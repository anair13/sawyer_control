...
import pickle
data = pickle.load(open("/home/ashvin/ros_ws/reset2.p", "rb"), encoding="bytes")
...
pos_low[0] = 0.4 # POSITION_RESET_POS[0] - max_offset
pos_high[0] = 0.8 # POSITION_RESET_POS[0] + 2 * max_offset
pos_low[1] = -0.2 #0.3 # POSITION_RESET_POS[1] - max_offset
pos_high[1] = 0.24 # POSITION_RESET_POS[1] + max_offset
pos_low[2] = 0.17 # POSITION_RESET_POS[2] - 0.02 # max_offset
pos_high[2] = 0.4 # POSITION_RESET_POS[2] + 0.02 # max_offset
